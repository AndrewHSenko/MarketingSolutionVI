...
const Sample = ({isActive}) => {
  return (
    <div className="d-flex justify-content-center align-items-center w-100 ps-1">
      <div className="card text-dark p-0 px-5 py-5 mx-auto">
          <img src={sample} className="card-img" alt="Sample spreadsheet" />
          ...
          <button className={`card-img-overlay p-0 d-md-flex d-none justify-content-center align-items-center h-100 bg-primary ${isActive === 'sample' ? "bg-opacity-75" : "bg-opacity-25"}`}>
