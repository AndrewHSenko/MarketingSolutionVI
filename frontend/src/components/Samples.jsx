    ...
    return (
        <div className="container-fluid my-4">
            <div className="row d-flex justify-content-center mb-3">
                <div
                    className="col-12 col-lg-6 d-flex flex-column align-items-center mt-3 mx-0 px-0"
                    onMouseEnter={() => setActive("sample")}
                    onMouseLeave={() => setActive(null)}
                >
                    <h1 className="display-6 text-center py-3">Sample Marketing Solution VI List</h1>
                ...
                <div className="col-12 col-lg-6 d-flex flex-column justify-content-center align-items-center mt-3 mx-0 px-0">
                    <h1 className="display-6 text-center py-3">Sample Marketing Solution VI Map</h1>
