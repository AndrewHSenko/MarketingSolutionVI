            ...
            <nav className="navbar navbar-expand-lg w-100">
                <div className="container-fluid mx-4">
                  <div className="d-flex flex-column align-items-center justify-content-center ms-md-4">
                    <Link to="/" className="navbar-brand me-0" aria-current="page">
                          <img src={logo} alt="MSVI logo" className="img-fluid logo"/>
                      </Link>
                    <h1 className="d-none d-lg-block text-center text-nowrap text-primary-dark lead fs-lg-3 fs-4">Marketing Solution VI</h1>
                  </div>
